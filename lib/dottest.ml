...
(*How do I convert the transitions to strings, and in DOT syntax?*)

let result = Semantic.transList (*Just storing the list of collected transitions here, for now.*)
let stuff = Semantic.collect_transitions (*Same as above*)
